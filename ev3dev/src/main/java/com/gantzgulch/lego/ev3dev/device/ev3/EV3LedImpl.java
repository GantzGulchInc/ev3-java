...
public class EV3LedImpl implements EV3Led {
    ...
    private final BidirectionalEnumMap<EV3LedTrigger> triggerMap;
    ...
    public EV3LedImpl(final Path sysPath, final BidirectionalEnumMap<EV3LedTrigger> triggerMap) {
    ...
    @Override
    public Optional<EV3LedTrigger> getTrigger() {
    ...
    @Override
    public void setTrigger(final EV3LedTrigger newTrigger) {

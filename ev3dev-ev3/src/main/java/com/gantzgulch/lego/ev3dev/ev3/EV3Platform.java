...
public class EV3Platform extends AbstractPlatform {
    ...
    public EV3Platform() {
        super("EV3", createBoards(), EV3OutputPortMap.INSTANCE, EV3InputPortMap.INSTANCE);
    }
    ...
    private Map<Pair<Integer, EV3LedColor>, EV3Led> createLedMap() {
        ...
        m.put(new Pair<>(0, EV3LedColor.GREEN), new EV3LedImpl(Path.of("/sys/class/leds/led0:green:brick-status"), EV3LedTriggerMap.INSTANCE));
        m.put(new Pair<>(0, EV3LedColor.RED), new EV3LedImpl(Path.of("/sys/class/leds/led0:red:brick-status"), EV3LedTriggerMap.INSTANCE));
        m.put(new Pair<>(1, EV3LedColor.GREEN), new EV3LedImpl(Path.of("/sys/class/leds/led1:green:brick-status"), EV3LedTriggerMap.INSTANCE));
        m.put(new Pair<>(1, EV3LedColor.RED), new EV3LedImpl(Path.of("/sys/class/leds/led1:red:brick-status"), EV3LedTriggerMap.INSTANCE));

...
public class SetRampUp extends AbstractCommand {

    private Duration duration;

    public SetRampUp(final String[] args) {
        super(args);
    }
    ...
    public static final SetRampUp parse(final String[] args) {
        return new SetRampUp(args);
    }
}

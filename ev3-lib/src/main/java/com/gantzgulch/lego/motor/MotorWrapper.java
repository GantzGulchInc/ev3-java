...
public interface MotorWrapper {
    ...
    void onForRotations(double rotations, boolean useBrake, boolean wait);
    
    void onForDegrees(double degrees, boolean useBrake, boolean wait);
    
    void onForDistance(Wheel wheel, double lenthUnit, LengthUnit unit, boolean useBrake, boolean wait);

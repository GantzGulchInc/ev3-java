...
public class AbstractDevice<CMDS extends Enum<?>> implements Device<CMDS> {
    ...
    public AbstractDevice(final Path sysFsPath, final BidirectionalEnumMap<CMDS> commandMap) {
        ...
        this.address = new Attribute(AttributeType.READ_ONLY, this.sysFsPath, ATTR_ADDRESS);
        this.driverName = new Attribute(AttributeType.READ_ONLY, this.sysFsPath, ATTR_DRIVER_NAME);
        this.command = new Attribute(AttributeType.WRITE_ONLY, this.sysFsPath, ATTR_COMMAND);
        this.commands = new Attribute(AttributeType.READ_ONLY, this.sysFsPath, ATTR_COMMANDS);
    }

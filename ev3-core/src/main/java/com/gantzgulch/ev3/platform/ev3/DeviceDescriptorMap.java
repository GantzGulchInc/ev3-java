...
import com.gantzgulch.ev3.platform.ev3.device.EV3LargeMotorImpl;
import com.gantzgulch.ev3.platform.ev3.device.EV3MediumMotorImpl;
import com.gantzgulch.ev3.platform.ev3.device.EV3TouchSensorImpl;
import com.gantzgulch.ev3.util.Cast;

public class DeviceDescriptorMap<T extends Device<?>, U extends Device<?>> {

    public static class OutputDeviceDescriptorMap extends DeviceDescriptorMap<OutputDevice<?>, OutputDevice<?>> {
    ...
    public static class InputDeviceDescriptorMap extends DeviceDescriptorMap<InputDevice<?>, InputDevice<?>> {
